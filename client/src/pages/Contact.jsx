        ...
        <header id="masthead" className="site-header dsvy-header-style-4">
          ...
          <div className="dsvy-slider-area">
            ...
            <div className="slider-container mt-4">
              ...
              <div className="slider-title">Contact</div>
            </div>
          </div>
        </header>
                                  ...
                                  <div className="elementor-widget-container elementor-01">
                                    ...
                                    >
                                      <div className="designervily-element-inner">
                                        ...
                                        <div className="dsvy-element-posts-wrapper element-02 row multi-columns-row">
                                          <article className="dsvy-ele dsvy-ele-service dsvy-service-style-2 col-md-8 surgery dsvy-term-26">
                                            <div
                                              className="designervily-post-item text-light"
                                              style={{ fontSize: "20px" }}
                                            >
                                              <span className="head-line"></span>
                                              Do you have questions about our
                                              activities in the areas where we
                                              work, or do you want to receive
                                              more info on periodic gifting,
                                              donations, sponsoring, gifting in
                                              your will, legacy gifting or
                                              company contributions? Please get
                                              in touch. You can reach us in
                                              various ways.
                                            </div>
                                          </article>
                          ...
                          <div className="elementor-container elementor-column-gap-no">
                            ...
                            >
                              <div className="elementor-widget-wrap elementor-element-populated">
                                ...
                                >
                                  <div className="elementor-widget-container">
                                    You can always change, stop, or increase
                                    your donation. The easiest way is to send an
                                    email to
                                    info@blessedvictoriaagenyifoundation.nl.
                                    Please include your name, postal code, house
                                    number, phone number, and the reason for
                                    your change. We will do our best to process
                                    this within a few working days. If you want
                                    to receive less or more information: send us
                                    an email with your request. We are happy to
                                    help. Without the support of donors, we
                                    cannot do our work, so we hope you will
                                    continue to support us for as long as
                                    possible. Of course, this can be for any
                                    amount, at any time that suits you.
                                  </div>
                                </div>
                                <div
                                  ...
                                  <div className="elementor-widget-container">
                                    <div className="dsvy-ihbox dsvy-ihbox-style-5">
                                      <div className="d-flex">
                                        ...
                                        <div className="dsvy-ihbox-contents">
                                          <h2 className="dsvy-element-title">
                                            info@blessedvictoriaageny <br />{" "}
                                            ifoundation.nl
                                          </h2>
                                          <div className="dsvy-heading-desc">
                                            By email: We aim to answer each
                                            email within several business days.
                                          </div>
                                        </div>
                                      </div>
                                    </div>
                  ...
                  <div className="row">
                    <div className="col-md-6">
                      <div className="dsvy-footer-copyright-text-area">
                        Copyright &copy; 2026-
                        <a href="#">Blessed-Victoria-Agenyi-Foundation(NGO)</a>,
                        All Rights Reserved.
                      </div>
                    </div>
                    <div className="col-md-6">
